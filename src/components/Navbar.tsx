    ...
    <div className="sticky top-0 z-50 flex justify-center w-full">
      <nav
        ...
        <div className="flex justify-center space-x-[0.95rem] py-1.5 px-2.5 mx-0.5 border rounded-full border-zinc-800">
          ...
          <a title="Patreon" target="_blank" href="https://www.patreon.com/sidestore"
          ...
          {/* <a title="Discord" href="https://discord.gg/RgpFBX3Q3k" target="_blank"
            className="flex justify-center w-6 h-6 transition-colors duration-100 text-zinc-300 hover:text-white"><svg
